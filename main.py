...
BOT_TOKEN = '8722110793:AAGedbmhX_8FWAybhdqlPRLttLFvMn-jOAs'
...
def start_cmd(message):
    bot.send_message(message.chat.id, """WeLcOmE To BoT 39rB HEX
...
DeVeLoPr By => @x39rb_hex 
AdMiN By => @sk7_py
ChAnnEl => @Hex_39
GrOup => @TzEXksoobba7864
""") 
#-------------(ar)-------------
...
تم التطوير بواسطة => @x39rb_hex
إدارة بواسطة => @sk7_py
القناة => @Hex_39
المجموعة => @TzEXksoobba7864
""")
#-------(طمس هوية)-------
